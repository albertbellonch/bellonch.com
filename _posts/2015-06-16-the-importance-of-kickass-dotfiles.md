...
<img src="{% ministamp _site/assets/images/posts/dotfiles/albertbellonch.png /assets/images/posts/dotfiles/albertbellonch.png %}" alt="Screenshot" class="screenshot">
